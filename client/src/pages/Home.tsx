...
export default function Home() {
  ...
  const skills = {
    ...
    additional: [
      "Responsive Design", "RESTful API", "GraphQL",
  ...
  const projects = [
    {
      ...
      description: "현대적인 UI/UX를 갖춘 전자상거래 플랫폼. React와 TypeScript로 구축하여 장바구니, 결제, 사용자 인증 기능을 구현했습니다.",
      image: "/project-1.png",
      tags: ["React", "TypeScript", "Tailwind CSS", "REST API"],
      link: "#",
      liveDemo: "https://example.com/ecommerce",
      github: "https://github.com/example/ecommerce",
      details: "이 프로젝트는 완전한 전자상거래 플랫폼으로, 상품 검색, 장바구니 관리, 결제 처리, 주문 추적 등의 기능을 포함합니다. Redux를 사용한 상태 관리와 Stripe API를 통한 결제 처리가 구현되어 있습니다."
    },
    {
      title: "Task Management App",
      description: "직관적인 드래그 앤 드롭 인터페이스를 갖춘 태스크 관리 애플리케이션. 실시간 동기화와 팀 협업 기능을 제공합니다.",
      image: "/project-2.png",
      tags: ["Next.js", "React", "Framer Motion", "Firebase"],
      link: "#",
      liveDemo: "https://example.com/taskapp",
      github: "https://github.com/example/taskapp",
      details: "Framer Motion을 활용한 부드러운 드래그 앤 드롭 애니메이션과 Firebase Realtime Database를 통한 실시간 동기화가 특징입니다. 팀 멤버 초대, 권한 관리, 알림 기능 등이 포함되어 있습니다."
    }
  ];
  ...
  const experiences = [
    {
      ...
      company: "테크 스타트업",
      period: "2022.03 - 현재",
      description: "React 기반 웹 애플리케이션 개발 및 팀 리딩. 성능 최적화로 로딩 속도 40% 개선, 컴포넌트 라이브러리 구축으로 개발 생산성 향상."
    },
    {
      title: "프론트엔드 개발자",
      company: "디지털 에이전시",
      period: "2020.01 - 2022.02",
      description: "다양한 클라이언트 프로젝트의 프론트엔드 개발 담당. 반응형 웹사이트 및 랜딩 페이지 제작, 크로스 브라우저 호환성 확보."
    },
    {
      title: "주니어 웹 개발자",
      company: "IT 솔루션 기업",
      period: "2018.06 - 2019.12",
      description: "웹 애플리케이션 유지보수 및 신규 기능 개발. HTML, CSS, JavaScript를 활용한 UI 구현 및 API 연동 작업."
    }
  ];
  ...
  const education = [
    {
      ...
      description: "웹 개발, 데이터베이스, 알고리즘 등 컴퓨터과학 기초 학습. 캡스톤 프로젝트로 React 기반 웹 애플리케이션 개발."
    },
    {
      school: "온라인 교육 플랫폼",
      degree: "Advanced React & TypeScript",
      period: "2021.06 - 2021.09",
      description: "React 고급 패턴, TypeScript 심화, 성능 최적화 등을 학습. 실무 프로젝트 기반 교육 이수."
    },
    {
      school: "개발자 부트캠프",
      degree: "Full Stack Web Development",
      period: "2017.09 - 2018.02",
      description: "HTML, CSS, JavaScript, Node.js, MongoDB 등 풀스택 개발 기술 습득. 4개의 실무 프로젝트 완료."
    }
  ];
          ...
          <div className="max-w-4xl mx-auto space-y-6 mt-8">
            <ScrollAnimatedElement type="fadeInUp" delay={0}>
              <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                ...
                <br />
                <span className="bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">프론트엔드 개발자</span>
                <br />
                <span className="bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">김태우</span>
            ...
            <ScrollAnimatedElement type="fadeInUp" delay={0.1}>
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed pt-6">
                React, TypeScript, 그리고 모던 웹 기술을 활용하여 아름답고 기능적인 웹 애플리케이션을 만듭니다. 
                사용자의 니즈를 이해하고 그에 맞는 솔루션을 제공하는 것이 저의 목표입니다.
              </p>
            </ScrollAnimatedElement>
              ...
              <ScrollAnimatedElement type="fadeInRight">
                <div className="space-y-6">
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    안녕하세요! 저는 <span className="text-foreground font-semibold">5년 이상의 경력</span>을 가진 프론트엔드 개발자입니다. 
                    사용자 중심의 인터페이스를 설계하고 구현하는 것에 열정을 가지고 있습니다.
                  </p>
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    React와 TypeScript를 주력으로 사용하며, 성능 최적화와 접근성을 고려한 웹 애플리케이션 개발을 지향합니다. 
                    새로운 기술을 배우고 적용하는 것을 즐기며, 팀과의 협업을 통해 더 나은 결과물을 만들어내는 것을 중요하게 생각합니다.
                  </p>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {projects.map((project, index) => (
                <ScrollAnimatedElement key={index} type="slideInUp" delay={index * 0.1}>
                  <Card 
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              {experiences.map((exp, index) => (
                <ScrollAnimatedElement key={index} type="fadeInLeft" delay={index * 0.1}>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              {education.map((edu, index) => (
                <ScrollAnimatedElement key={index} type="fadeInRight" delay={index * 0.1}>
