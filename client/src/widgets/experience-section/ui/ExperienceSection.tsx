        ...
        <div className="space-y-0">
          {timelineItems.map((item, index) => (
            <motion.article
              ...
              className="grid md:grid-cols-[120px_1fr] gap-8 md:gap-16 py-12 md:py-16 border-t border-border/80 group relative card-shine"
            >
              ...
              <div className="space-y-5 pl-0 md:pl-4">
                <div>
                  <h3 className="text-2xl md:text-3xl font-bold tracking-tight mb-2 group-hover:gradient-text-static transition-all">
                    {item.title}
                  </h3>
                ...
                <p className="text-muted-foreground leading-[1.75] max-w-3xl text-sm md:text-base">
                  {item.description}
                </p>
