    ...
    <section id="contactme" className="section-padding relative overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 mb-20 md:mb-28">
          ...
          >
            <p className="text-base md:text-lg font-medium mb-4 text-muted-foreground">
              Let&apos;s
            </p>
            <h2 className="display-title text-[clamp(4rem,14vw,9rem)] mb-8 gradient-text">
              Connect
            </h2>
            ...
            <div className="flex flex-col gap-3">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="group flex items-center gap-4 p-4 border border-border/60 bg-pearl-surface/40 hover:border-pearl-accent/50 hover:bg-pearl-accent/5 transition-all duration-300 card-shine"
                >
          ...
          <motion.form
            ...
            className="space-y-8 lg:pt-16 p-8 md:p-10 border border-border/60 bg-pearl-surface/30 backdrop-blur-sm"
          >
            <div>
              <label
                htmlFor="name"
                className="block text-[10px] font-bold tracking-[0.25em] uppercase mb-3 text-muted-foreground"
              >
                Full Name *
              </label>
              <input
            ...
            <button
              ...
              className="contact-btn contact-btn-glow w-full disabled:opacity-50 relative"
            >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.7 }}
          className="border-t border-border/60 pt-16 md:pt-20"
        >
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl">
            <p className="text-muted-foreground leading-[1.85] text-sm md:text-base">
              프론트엔드 개발과 UI 구현, API 연동 경험을 바탕으로 디자이너·백엔드
              팀과 원활히 협업합니다. 깔끔한 코드와 사용자 경험을 동시에
              추구합니다.
            </p>
            <p className="text-muted-foreground leading-[1.85] text-sm md:text-base">
              새로운 기술을 배우고 적용하는 것을 즐기며, 함께 성장할 수 있는
              환경을 찾고 있습니다.
            </p>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="spaced-letters mt-20 md:mt-28"
          aria-hidden
        >
